...
<head>
    ...
    <title>InfOrderSys Logs - Created by SEERSOL</title>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item {{ Route::is('dashboard') ? 'active' : '' }}">
                    <a href="{{ route('dashboard') }}" class="nav-link">
                        <i class="fa fa-fw fa-exclamation-triangle"></i> Admin InfSys
                    </a>
                </li>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            ...
            <p class="text-muted float-right">
                Created with <i class="fa fa-heart"></i> by <a href="http://seersol.com/" target="_blank">SEERSOL</a> <sup>&copy;</sup>
            </p>
        </div>
    </footer>
